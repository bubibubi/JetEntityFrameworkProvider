...
namespace JetDdexProvider
{
	...
	/// </summary>
	class JetObjectIdentifierResolver : DataObjectIdentifierResolver
	{
		/// <summary>
		/// Jet connections are always within the context of a single file.
        /// This method expands identifiers
